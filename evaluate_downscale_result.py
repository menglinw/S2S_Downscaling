...
def evaluate(d_data, df_data, t_data):
    n_lag = t_data.shape[0] - d_data.shape[0]
    print('Day: ', 'R2 w/o fine tune |', 'R2 with fine tune')
    for i in range(d_data.shape[0]):
        ...
        print('Day', i+1, ': ',  r2, r2_f)


def read_and_save(data_cache_path):
    d_data1, df_data1, t_data1 = read_downscale_data(data_cache_path, 'Season1')
    ...
    print('-------------Season 1---------------------')
    evaluate(d_data1, df_data1, t_data1)

    d_data2, df_data2, t_data2 = read_downscale_data(data_cache_path, 'Season2')
    ...
    print('-------------Season 2---------------------')
    evaluate(d_data2, df_data2, t_data2)

    d_data3, df_data3, t_data3 = read_downscale_data(data_cache_path, 'Season3')
    ...
    print('-------------Season 3---------------------')
    evaluate(d_data3, df_data3, t_data3)

    d_data4, df_data4, t_data4 = read_downscale_data(data_cache_path, 'Season4')
    ...
    print('-------------Season 4---------------------')
    evaluate(d_data4, df_data4, t_data4)
