...
if __name__ == '__main__':
    ...
    # process data
    # create area dataset
    get_data(data_cache_path, target_var, n_lag, n_pred, task_dim, train_set, area, AFG_only=AFG_only,
             stride=stride)
    ...
    history = generator.fit([X_high, X_low, X_ele, X_other], Y, epochs=1, callbacks=callbacks, validation_split=0.2)
